        ...
        <div className="about" id="about">
          <div className="cards">
            <div className="card">
              ...
              <p className="card-description">
                ...
                novas figuras que vão sendo adicionadas e conheça um pouco mais
                sobre Parintins!
              </p>
            </div>
            <div className="card">
              ...
              <p className="card-description">
                A partir da leitura de um QRCode, você consegue registrar todas
                as suas visitas pela cidade de Parintins de forma simples e
                eficaz!
              </p>
            </div>
            <div className="card">
              <TimelineIcon />
              <h2 className="card-title">Acompanhe seu histórico de visitas</h2>
              <p className="card-description">
                Acompanhe todo o histórico de visitas pela cidade de Parintins,
                tendo acesso a data e hora em que você realizou sua visita.
              </p>
            </div>
          </div>
          ...
          <div className="divisor">
            ...
            <p className="divisor-description">
              ...
              culturais e/ou pontos importantes da cidade de Parintins de forma
              digital!
            </p>
            <iframe
